...
namespace Rendering
{
    ...
    shaderFlags |= D3DCOMPILE_SKIP_OPTIMIZATION;
        ...
        {
       BasicEffectVertex(XMFLOAT4(-1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f,
       0.0f,0.0f,1.0f)),//red
       BasicEffectVertex(XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f,
       1.0f)),//green
       BasicEffectVertex(XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f,
       1.0f)),//blue
        };
